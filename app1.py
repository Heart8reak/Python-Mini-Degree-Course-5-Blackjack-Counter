...
def extract_cards(img, num_cards=4):
    ...
    contours = sorted(contours, key=None = cv2.contourArea, reverse = True)[:num_cards]

    return cards

def train(training_labels_fielname = 'train.tsv', training_image_filename = 'train.png', num_training_cards=56):
    """
    ...
    labels = {}
    for line in file(training_labels_fielname):
